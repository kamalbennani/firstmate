...
The [worker launch environment contract](../../../docs/configuration.md#worker-launch-environment-configlaunch-env-allowlist-and---env) separately governs explicit environment grants.
