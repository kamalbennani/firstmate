...
family_for_basename() {
  case "$1" in
    ...
    fm-pi-branch-responsiveness-live-e2e.test.sh|fm-pi-trust-live-e2e.test.sh|\
    ...
    fm-spawn-dispatch-profile.test.sh|fm-claude-trust.test.sh|fm-pi-trust.test.sh|\
...
tests/fm-pi-trust.test.sh 25124
